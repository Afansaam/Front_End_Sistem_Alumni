/**
 * Profil Alumni (Super Admin view) — stub.
 */
import { View, Text, StyleSheet } from "react-native";
import { Brand } from "@/constants/theme";

export default function SuperAdminProfilAlumniScreen() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Profil Alumni (Semua Data)</Text>
      <Text style={styles.subtitle}>[Fase 4] Akses super admin ke seluruh profil alumni.</Text>
    </View>
  );
}
