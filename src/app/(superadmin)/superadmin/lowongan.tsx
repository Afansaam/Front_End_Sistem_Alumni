/**
 * Kelola Lowongan (Super Admin view) — stub.
 */
import { View, Text, StyleSheet } from "react-native";
import { Brand } from "@/constants/theme";

export default function SuperAdminLowonganScreen() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Kelola Lowongan</Text>
      <Text style={styles.subtitle}>[Fase 4] Akses super admin untuk lowongan.</Text>
    </View>
  );
}
