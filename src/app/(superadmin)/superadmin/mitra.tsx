/**
 * Mitra Perusahaan (Super Admin view) — stub.
 */
import { View, Text, StyleSheet } from "react-native";
import { Brand } from "@/constants/theme";

export default function SuperAdminMitraScreen() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Mitra Perusahaan</Text>
      <Text style={styles.subtitle}>[Fase 4] Akses super admin untuk mitra perusahaan.</Text>
    </View>
  );
}
