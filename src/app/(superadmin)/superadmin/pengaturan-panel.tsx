/**
 * Pengaturan Panel — stub.
 */
import { View, Text, StyleSheet } from "react-native";
import { Brand } from "@/constants/theme";

export default function SuperAdminPengaturanScreen() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Pengaturan Panel</Text>
      <Text style={styles.subtitle}>[Fase 4] Konfigurasi UI dan behavior panel admin.</Text>
    </View>
  );
}
